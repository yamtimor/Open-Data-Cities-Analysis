...
The goal is simple: pick a city, pick a dataset, create a small analysis or visualization — and share it.
...
Contributions can be **simple** — a single notebook, a visualization, or a small script analyzing one dataset.
...
### 6. Commit & Push
git commit -m "Add <project> for <city>"
...
🎉 That’s it — your project joins the Open Data Cities library!
